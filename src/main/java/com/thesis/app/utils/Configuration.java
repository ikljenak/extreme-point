...
public class Configuration {
	...
	public static double FITNESS_A;
	public static double FITNESS_B;
	public static double FITNESS_C;
	...
	public static void setProperties(Properties properties){
		...
		FITNESS_A = Double.valueOf(properties.getProperty("fitness.a"));
		FITNESS_B = Double.valueOf(properties.getProperty("fitness.b"));
		FITNESS_C = Double.valueOf(properties.getProperty("fitness.c"));
	}
}
